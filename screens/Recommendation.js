...
export default class PopularScreen extends Component {
  constructor(props) {
    ...
    this.state = {
      data: [],
      ngrok_url:"https://ebe2-2406-7400-c4-b223-fcfb-c890-3d4e-96a5.in.ngrok.io"
    };
  }
  ...
  getData = () => {
     ...
     url = this.state.ngrok_url + "/recommended-articles"
      ...
      <View style={styles.cardContainer}>
        ...
        <View style={styles.movieTitleContainer}>
          ...
          <View style={{flexDirection:"row"}}>
            <Text style={styles.subtitle}>{item.number_of_pages} pages </Text>
